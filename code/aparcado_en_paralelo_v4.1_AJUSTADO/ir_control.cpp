  ...
  while(bDetectIR == true){
   if (irrecv.decode(&results)){ 
      ...
      switch(val){
        ...
        // Pivote
        case KEY7:            robotSetSpeed(speed); robotLeftPivotInstant();  Display(COD_L); break;
        case KEY9:            robotSetSpeed(speed); robotRightPivotInstant(); Display(COD_R); break;
        ...
        case KEY_STAR: bDetectIR = false;     
          ...
          break;
        default: Serial.print(val); Serial.println(" Unkown"); break;
      }
    }
  }
}
