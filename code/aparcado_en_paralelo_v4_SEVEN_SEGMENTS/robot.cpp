...
void robotRightInstant (){//declaramos la función digital robotLeftInstant que provocará que todos los motores desplacen al robot hacia la izquierda indefinidamente
...
void robotLeftInstant (){//declaramos la función digital robotRightInstant que provocará que todos los motores desplacen al robot hacia la derecha indefinidamente
  M1Forward();//ejecutamos la función digital M1Forward que hace que los motores M1 avancen hacia adelante indefinidamente
